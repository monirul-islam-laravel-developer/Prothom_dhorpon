    ...
    <div class="col-md-12 col-sm-12">
        <div class="card box-shadow-0">
            <div class="card-header border-bottom">
                <h4 class="card-title">Reporter Add Form</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('reporter.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input
                        type="text"
                        name="designation" class="form-control" placeholder="Enter your Reporter Designation">
                    </div>
                    <div class="form-group">
                        <label for="categoryName">Mobile</label>
                    <input
                        type="number"
                        name="mobile" class="form-control" placeholder="Enter your Reporter Mobile Number">
                    </div>
                    <div class="form-group">
                        <label for="categoryName">Nid</label>
                    <input
                        type="number"
                        name="nid" class="form-control" placeholder="Enter your Reporter Nid Number">
                    </div>
                    <div class="form-group">
                        <label for="categoryName">Address</label>
                    <input
                        type="text"
                        name="address" class="form-control" placeholder="Enter your Reporter Address">
                    </div>
                    <div class="form-group">
                        <label for="categoryName">Blood Group</label>
                    <input
                        type="text"
                        name="blood_group" class="form-control" placeholder="Enter your Reporter Blood Group">
                    </div>
                    <div class="form-group">
