            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Basic Element</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{route('subcategory.index')}}" class="slide-item">Sub Category</a></li>
                        <li><a href="" class="slide-item">Reporter</a></li>
                        <li><a href="" class="slide-item">Unit</a></li>
                        <li><a href="" class="slide-item">Product</a></li>
                        <li><a href="" class="slide-item">Size</a></li>
                        <li><a href="" class="slide-item">Weight</a></li>
