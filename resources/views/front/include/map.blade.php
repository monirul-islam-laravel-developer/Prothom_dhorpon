<div class="dect-map">
    ...
    s0.1,1.4,0.1,1.4l1,1.1l0.5,0.6l1.6-0.9l1.1-0.2c0,0,0-1.1,0-1.6s0-1,0-1l-0.6-0.5C317.8,142.6,317.4,142.5,316.5,142.1z"></path>
        ...
        @php
            $rongpur = \App\Models\SubCategory::find(15);
        @endphp


        <g id="rangpur">
            <a href="{{route('sub-category-news',[$rongpur->id,$rongpur->slug])}}" xlink:href="#">
    ...
    C-149.4-371.1-151.4-371-152-370.6z"></path>
        ...
        @php
            $sylhet = \App\Models\SubCategory::find(13);
        @endphp
        <g id="sylhet">
            <a href="{{route('sub-category-news',[$sylhet->id,$sylhet->slug])}}" xlink:href="#">
    ...
    l-5,1.2l-4.8,1.5L143.6-178.4z"></path>
        ...
        @php
            $khulna = \App\Models\SubCategory::find(12);
        @endphp

        <g id="khulna">
            <a href="{{route('sub-category-news',[$khulna->id,$khulna->slug])}}" xlink:href="#">
        ...
        @php
            $dhaka = \App\Models\SubCategory::find(10);
        @endphp
        <g id="dhaka">
            <a href="{{route('sub-category-news',[$dhaka->id,$dhaka->slug])}}" xlink:href="#">
        ...
        @php
            $mymensingh = \App\Models\SubCategory::find(16);
        @endphp
        <g id="mymensingh">
            <a href="{{route('sub-category-news',[$mymensingh->id,$mymensingh->slug])}}" xlink:href="#">
        ...
        @php
            $rajshahi = \App\Models\SubCategory::find(9);
        @endphp

        <g id="rajshahi">
            <a href="{{route('sub-category-news',[$rajshahi->id,$rajshahi->slug])}}" xlink:href="#">
      ...
      l-1.2-1.6l-1.4,0.1h-1.5l-0.9,0.4l-2.5,0.9l-0.8,0.1c0,0-1,0-1.5,0.1s-1.9,0.1-1.9,0.1s-0.2,1-0.6,1.2s-0.4,0.2-0.4,0.2v1.2H-184z"></path>
        ...
        @php
            $borishal = \App\Models\SubCategory::find(14);
        @endphp
        <g id="borishal">
            <a href="{{route('sub-category-news',[$borishal->id,$borishal->slug])}}" xlink:href="#">
        ...
        @php
            $chittagong = \App\Models\SubCategory::find(11);
        @endphp
        <g id="chittagong">
            <a href="{{route('sub-category-news',[$chittagong->id,$chittagong->slug])}}" xlink:href="#">
